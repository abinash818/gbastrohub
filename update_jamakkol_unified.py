...
def main():
    ...
    # The block starts with <div style="display: flex; gap: 4mm; margin: 4mm 0; align-items: flex-start;">
    # We will replace everything up to the closing div of this flex container.
    
    # Let's find the exact block.
    # It starts just after details-grid closing div.
    
    old_section = r'''          <div style="display: flex; gap: 4mm; margin: 4mm 0; align-items: flex-start;">
            <div style="flex: 0 0 52%; padding: 4.5mm; border: 0.5mm solid #1E3A8A; border-radius: 1mm;">
            ...
            <div style="flex: 0 0 45%;">
                <div style="border: 0.3mm solid var(--border-orange); border-radius: 1mm; padding: 1.5mm; margin-bottom: 1.5mm; background: #fff;">
                  ...
                  <div style="border-top: 0.3mm solid var(--border-orange); margin-top: 0.5mm; padding-top: 0.5mm;">
                ...
                <div style="border: 0.3mm solid var(--border-orange); border-radius: 1mm; padding: 1.5mm; background: #fff;">
                  <div style="color: var(--header-blue); font-weight: bold; font-size: 3mm; margin-bottom: 2mm; display: flex; align-items: center;">
    ...
    new_section = r'''          <div style="display: flex; margin: 3mm 0; align-items: stretch; border: 0.5mm solid #1E3A8A; border-radius: 1mm; background: #FAF6EE; overflow: hidden;">
            ...
            <div style="flex: 1; border-left: 0.5mm solid #1E3A8A; padding: 2mm; display: flex; flex-direction: column;">
                ...
                <div style="border-top: 0.3mm dashed #ccc; padding-top: 1mm; margin-bottom: 1mm;">
                ...
                <div style="border-top: 0.3mm dashed #ccc; padding-top: 1mm; margin-bottom: 2mm;">
                ...
                <div style="background: var(--header-blue); color: white; padding: 1mm; font-size: 2.2mm; font-weight: bold; text-align: center; border-radius: 0.5mm; margin-bottom: 1.5mm; margin-top: auto;">
                   ⚡ கதிர் பலம் (Strength)
                </div>
    ...
    if old_section in content:
        ...
        print("Could not find the exact old section to replace.")
