...
void main() {
  ...
  test('Calculate SubPlanets for 15-04-2026 23:59:59', () async {
    await KPService.init();

    final dt = DateTime(2026, 4, 15, 23, 59, 59);
    ...
    // 15-04-2026 Sunrise/Sunset for Namakkal
    DateTime sunrise = DateTime(2026, 4, 15, 6, 10, 0);
    DateTime sunset = DateTime(2026, 4, 15, 18, 29, 0);
    DateTime nextSunrise = DateTime(2026, 4, 16, 6, 9, 0);
    DateTime prevSunset = DateTime(2026, 4, 14, 18, 29, 0);
    ...
    print('\n======================================================');
    print('15-04-2026 23:59:59 (Wednesday Night) - NAMAKKAL');
    print('======================================================');
